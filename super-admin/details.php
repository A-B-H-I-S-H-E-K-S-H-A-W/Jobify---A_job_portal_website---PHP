          ...
          <div class="grid grid-cols-1 gap-5 shadow-xl mt-5">
            <div class=" h-full ring-1 ring-gray-400 p-6 rounded-xl grid grid-cols-3 gap-3">
                ...
                <div class="border-t py-5 w-full flex justify-end">
                    <a href="" class="px-4 py-2 rounded-lg bg-black text-white font-semibold hover:ring-1 hover:ring-black-900 hover:bg-white hover:text-black duration-300 ease-linear">Approve</a>
                </div>
            </div>
          </div>
        </div>
